...
@section('admin')
    ...
    <div class="page-content">
        <div class="container-fluid">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="name" class="form-control" type="text"
                                            value="{{ $user->name }}" id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->

                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">User Email</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="username" class="form-control" type="text"
                                            value="{{ $user->username }}" id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
            ...
            @include('admin.partials.admin-update-password-form')
